-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('PATIENT', 'RECEPTIONIST', 'DOCTOR', 'ADMIN');

-- CreateEnum
CREATE TYPE "AppointmentStatus" AS ENUM ('AVAILABLE', 'BOOKED', 'CANCELLED', 'COMPLETED');
...
CREATE TABLE "AvailableSchedule" (
    ...
    CONSTRAINT "AvailableSchedule_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "AvailableSchedule_doctorId_idx" ON "AvailableSchedule"("doctorId");
